...
Stokes::setup()
{
  ...
  // Initialize the linear system.
  {
    ...
    pcout << "  Initializing the residual" << std::endl;
    residual.reinit(block_owned_dofs, MPI_COMM_WORLD);
...
void
Stokes::assemble(bool first_step)
{
  pcout << "===============================================" << std::endl;
      ...
      if (residual_norm > residual_tolerance)
        {
          ...
          system_matrix.residual(residual, solution_owned, system_rhs);
